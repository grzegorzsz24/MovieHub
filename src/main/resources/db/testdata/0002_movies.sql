...
insert into movie (title, original_title, release_year, promoted, genre_id, description, short_description, youtube_trailer_id) values ('Submerged', 'Artist and the Model, The (El artista y la modelo)', 2020, true, 6, 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.
